// Nice Scroll
jQuery("html").niceScroll({cursorborder:"",cursorcolor:"#fc0881",cursorwidth:"7px",cursorborderradius:"0px"});
jQuery(".header").niceScroll({cursorborder:"",cursorcolor:"#e50b77",cursorwidth:"7px",cursorborderradius:"0px"});

// Loader
// ======================
jQuery("body").queryLoader2({
        barColor: "#fc0881",
        backgroundColor: "#fc0881",
        percentage: false,
        barHeight: 3,
